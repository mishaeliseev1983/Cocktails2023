...
interface CocktailsRepository {
    suspend fun getListSubcategories(category: String): List<SubcategoryDomain>
    suspend fun getListCocktails(category: String, subcategory: String): List<CocktailShortDomain>
